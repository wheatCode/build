class repair_show_repair_page extends ActionHandler {
    ...
    ajax_success(json_str) {
        ...
        $(document).ready(function() {
			...
			//$("#picker-image").change(function() {
              //  $("#preview_progressbarTW_imgs").html(""); // 清除預覽
              //  readURL(this);
             //   var file = document.querySelector('#picker-image').files[0];
             //   getBase64(file)
             //   console.log(file);
            //});
                ...
                if (input.files && input.files.length >= 0) {
                    for (var i = 0; i < input.files.length; i++) {
                        ...
                        reader.onload = function(e) {
							...
							$("#picker-image").attr('src', e.target.result);
                            ...
                            <textarea type="text" id="case_content" class="form-control md-textarea ml-4" rows="4"></textarea>
                                        ...
                                        <div class="col-12">
                                            <div class="md-form row">
											   <input type="button" id="incambut" value="拍照">
                                               <input type="file" id="progressbarTWInput" accept="image/jpeg" multiple/ >
											   
											   <img width='300' height='200' id="picker-image">
