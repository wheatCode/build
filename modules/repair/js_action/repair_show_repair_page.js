...
<input placeholder="結束時間" type="time" id="input_starttime1-2" style="min-width:100%" class="form-control">
                    ...
                    $("#addbtn").click(function() {
                        ...
                        if (n1 < 3) {
                            ...
                            $("#timearea2").append(`<div class="row mt-2 pt-0 pb-3" id="div` + txtId + `" >
                            <div class="col-12 pr-0">

                            <input type="date" style="min-width:100%"class="form-control" id="date1" placeholder="Enter month">
                        </div>
                        <div class="col-12 pr-0" >
                            <input placeholder="起始時間" type="time" id="input_starttime2-1" style="min-width:100%"class="form-control">
                        </div>
                        <div class="col-12 pr-0">
                            <input placeholder="結束時間" type="time" id="input_starttime2-2" style="min-width:100%"class="form-control">
                        </div>   
                                                        <div class="col-1">    
