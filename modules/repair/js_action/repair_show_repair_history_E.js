            ...
            if (obj['status_code'] == 1 || obj['check_finish'] == "finish") {
                ...
                content += `
                                ...
                                <tr>
                                    ...
                                    <td class="font30" width="25%"><div class="row mt-0"><div class="col-6 mr-0 pr-0"><input type="text" id="new_time" class="form-control" style = "font-size:30px"></div><div class="col-6">小時</div></div></td>
