class news_do_select_action extends ActionHandler {
    ...
    ajax_success(xhttp) {
        ...
        for (var i in info) {
            ...
            str += `<div class="row"><div class="col-12"><a  onclick="(new news_show_news_page('news', 'show_news_page', 'body', '${info[i]["id"]}')).run();"><div class="row mt-2"><div class="col px-0"><div class="row border boxShadow mx-1 mt-0"><div class="col-5 px-0">`;
