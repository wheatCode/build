class home_show_home_page_P extends ActionHandler {
    ...
    ajax_success(xhttp) {
        try {
            ...
            <a onclick="(new home_show_home_page_P('home','show_home_page_P','body')).run()"class="nav-link"><img src="/logo/logo.png" width="200" height="80" class="img-fluid flex-center"></a>
