        ...
        try {
            ...
            <div class="col-lg-12 col-md-7">
                ...
                <div>
                    ...
                    <option value=""></option>
                    `;
                    for(var Data in phpDatas[0]['buildingAll']){
                        data+=`<option value="${phpDatas[0]['buildingAll'][Data]['id']}">${phpDatas[0]['buildingAll'][Data]['name']}</option>`;
                    }
                    data+=`
                    </select>
                    ...
                    <option value=""></option>
                    `;
                    for(var Data in phpDatas[0]['repairTypeAll']){
                        data+=`<option value="${phpDatas[0]['repairTypeAll'][Data]['id']}">${phpDatas[0]['repairTypeAll'][Data]['namech']}</option>`;
                    }
                    data+=`
                    </select>
            ...
            for(var phpData in phpDatas){
                var start_datetime = phpDatas[phpData]['case']['start_datetime'].substring(0,4)+"/"+phpDatas[phpData]['case']['start_datetime'].substring(5,7)+"/"+phpDatas[phpData]['case']['start_datetime'].substring(8,10);
                             ...
                             <tr>
                                ...
                                <td class="w-15 py-2">${phpDatas[phpData]['houseHold']['houseHoldProfile'][0]['number']}</td>
